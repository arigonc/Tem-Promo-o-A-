<section style="min-height: 100vh;">
    ...
    <div class="d-block p-5 my-4 mx-auto w-75 bg-white center rounded border">
        ...
        <form action="<?= URL ?>/promocoes/cadastrar" method="post" autocomplete="off">
            <p class="fs-6 fw-semibold">Dados do produto:</p>
            <div class="row">
                <div class="col-md-6 mt-3">
                    <label class="form-label">Título<span class="mx-1 text-danger">*</span></label>
                    <input type="text" class="form-control <?= $dados['titulo_erro'] ? "is-invalid" : "" ?>" name="titulo" value="<?= $dados['titulo'] ?>">
                ...
                <div class="col-md-3 mt-3">
                    ...
                    <input type="text" class="form-control <?= $dados['marca_erro'] ? "is-invalid" : "" ?>" name="marca" value="<?= $dados['marca'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['marca_erro'] ?>
                    </div>
                </div>
                <div class="col-md-3 mt-3">
                    ...
                    <input type="date" class="form-control <?= $dados['validade_erro'] ? "is-invalid" : "" ?>" name="validade" value="<?= $dados['validade'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['validade_erro'] ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    ...
                    <input type="date" class="form-control <?= $dados['data_inicio_erro'] ? "is-invalid" : "" ?>" name="data_inicio" value="<?= $dados['data_inicio'] ?>">
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <input type="date" class="form-control <?= $dados['data_fim_erro'] ? "is-invalid" : "" ?>" name="data_fim" value="<?= $dados['data_fim'] ?>">
                    <div class="invalid-feedback">
                        <?= $dados['data_fim_erro'] ?>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 mt-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control <?= $dados['imagem_erro'] ? "is-invalid" : "" ?>" name="imagem" value="<?= $dados['imagem'] ?>">
                    </div>
                    <div class="invalid-feedback">
                        <?= $dados['imagem_erro'] ?>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control <?= $dados['preco_inicio_erro'] ? "is-invalid" : "" ?>" name="preco_inicio" value="<?= $dados['preco_inicio'] ?>">
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mt-3">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text">R$</span>
                        <input type="text" class="form-control <?= $dados['preco_fim_erro'] ? "is-invalid" : "" ?>" name="preco_fim" value="<?= $dados['preco_fim'] ?>">
                        <div class="invalid-feedback">
